...
void edit_window_init_options_struct( void ) {
    ...
    menu.option[PWM_INDEX].step  = 1;
    menu.option[PWM_INDEX].digit_index  = 2;
    ...
    menu.option[DFREQ_INDEX].step  = 1;
    menu.option[DFREQ_INDEX].digit_index  = 3;
    ...
    menu.option[DPWM_INDEX].step  = 1;
    menu.option[DPWM_INDEX].digit_index  = 2;
    ...
    menu.option[TIME1_INDEX].step  = 1;
    menu.option[TIME1_INDEX].digit_index  = 1;
    ...
    menu.option[TIME0_INDEX].step  = 1;
    menu.option[TIME0_INDEX].digit_index  = 1;
