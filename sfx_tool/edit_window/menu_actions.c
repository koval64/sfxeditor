...
{
    COLOR_RAM[PWM_DIGITS_POS + menu.option[PWM_INDEX].digit_index] = OPTION_COLOR_GRAY_OUT;
    ...
    COLOR_RAM[PWM_DIGITS_POS + menu.option[PWM_INDEX].digit_index] = OPTION_COLOR_SELECTED;
}
...
{
    for (unsigned pos = WAVEFORM_VALUE_POS; pos < (WAVEFORM_VALUE_POS + 5); pos++)
        COLOR_RAM[pos] = color;
}
...
void waveform_menu_option_pulse(char color)
{
    ...
    if (color == OPTION_COLOR_GRAY_OUT)
    ...
    if (color == OPTION_COLOR_GRAY_OUT)
        // show PWM options
        color = OPTION_COLOR_GRAY_OUT;
    else
        // hide PWM options
        color = OPTION_COLOR_OFF;
...
void waveform_menu_change_option(byte value)
{
    ...
    if (menu.option[WAVEFORM_INDEX].value == WAVE_PULSE)
        waveform_menu_set_option(OPTION_COLOR_SELECTED);
    ...
    // select new waveform
    waveform_menu_set_option(OPTION_COLOR_GRAY_OUT);
}
...
{
    COLOR_RAM[DFREQ_DIGITS_POS + menu.option[DFREQ_INDEX].digit_index] = OPTION_COLOR_GRAY_OUT;
    ...
    COLOR_RAM[DFREQ_DIGITS_POS + menu.option[DFREQ_INDEX].digit_index] = OPTION_COLOR_SELECTED;
}
...
{
    COLOR_RAM[DPWM_DIGITS_POS + menu.option[DPWM_INDEX].digit_index] = OPTION_COLOR_GRAY_OUT;
    ...
    COLOR_RAM[DPWM_DIGITS_POS + menu.option[DPWM_INDEX].digit_index] = OPTION_COLOR_SELECTED;
}
...
{
    COLOR_RAM[TIME1_DIGITS_POS + menu.option[TIME1_INDEX].digit_index] = OPTION_COLOR_GRAY_OUT;
    ...
    COLOR_RAM[TIME1_DIGITS_POS + menu.option[TIME1_INDEX].digit_index] = OPTION_COLOR_SELECTED;
}
...
{
    COLOR_RAM[TIME0_DIGITS_POS + menu.option[TIME0_INDEX].digit_index] = OPTION_COLOR_GRAY_OUT;
    ...
    COLOR_RAM[TIME0_DIGITS_POS + menu.option[TIME0_INDEX].digit_index] = OPTION_COLOR_SELECTED;
}
